...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract {
	 ...
	 * @var array
	 */
	protected $fillable = ['Login', 'FirstName', 'Password','LastLoginDate','LastName','Active', 'Address', 'Address2', 'City', 'StateID', 'CountryID', 'DepartmentID', 'LMS', 'Active', 'Beta', 'ShowDemoReporting', 'PasswordChangedByAdmin', 'Locale', 'oldUser'];
	/**
