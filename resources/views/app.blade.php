...
<head>
	...
	<link href="{{ url('/assets/stylesheets/frontend.css') }}" rel="stylesheet">
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<img style="width: 45px; float: left;" src="{{ url('/images/starIcon.png') }}" alt="star icon"/><a class="navbar-brand" href="#"> Apex Innovations</a>
			</div>

			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="//www.apexinnovations.com">Home</a></li>
				</ul>
