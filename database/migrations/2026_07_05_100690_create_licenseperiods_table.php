...
class CreateLicensePeriodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('LicensePeriods', function (Blueprint $table) {
            $table->increments('ID');
            ...
            $table->enum('HardStop', ['Y', 'N'])->default('N');
        });
    }
    ...
    {
        Schema::dropIfExists('LicensePeriods');
    }
}
